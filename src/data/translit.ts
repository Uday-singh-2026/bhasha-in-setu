 ...
 * Approximate by design — a native-speaker panel should verify spellings.
 */
...
/**
 * Phonetically convert Devanagari words (such as names, proper nouns, or loanwords)
 * into Roman Latin phonetic script.
 */
...
/**
 * Convert Devanagari text directly to Ol Chiki script.
 */
